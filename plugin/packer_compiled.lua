...
_G.packer_plugins = {
  ...
  ["nvim-cmp"] = {
    after = { "cmp-rg", "nvim-snippy", "cmp-nvim-tags", "cmp-fuzzy-buffer", "cmp-nvim-lsp-signature-help", "cmp-nvim-lua", "cmp-buffer", "cmp-path", "cmp-cmdline", "cmp-tabnine", "cmp-nvim-lsp", "cmp-cmdline-history", "cmp-spell", "cmp-calc", "cmp-treesitter", "cmp-snippy", "cmp-fish" },
...
vim.cmd [[au FileType puml ++once lua require("packer.load")({'vim-slumlord', 'open-browser.vim', 'plantuml-syntax', 'plantuml-previewer.vim'}, { ft = "puml" }, _G.packer_plugins)]]
...
vim.cmd [[au FileType markdown ++once lua require("packer.load")({'markdown-preview.nvim', 'vim-markdown-toc', 'mkdnflow.nvim'}, { ft = "markdown" }, _G.packer_plugins)]]
...
vim.cmd [[au User s1 ++once lua require("packer.load")({'abbreinder.nvim', 'FixCursorHold.nvim', 'lsp-colors.nvim', 'indent-blankline.nvim', 'nvim-ts-rainbow', 'nvim-ts-context-commentstring', 'vim-im-select', 'stabilize.nvim', 'vim-hexokinase', 'falcon', 'hlargs.nvim', 'nvim-lspconfig', 'nightfox.nvim', 'due.nvim', 'oak', 'mkdir.nvim', 'nvim-treesitter-pairs', 'matchparen.nvim'}, { event = "User s1" }, _G.packer_plugins)]]
vim.cmd [[au InsertEnter * ++once lua require("packer.load")({'nvim-treesitter-endwise', 'nvim-cmp'}, { event = "InsertEnter *" }, _G.packer_plugins)]]
vim.cmd [[au CmdlineEnter * ++once lua require("packer.load")({'nvim-cmp', 'range-highlight.nvim', 'nvim-hlslens', 'numb.nvim'}, { event = "CmdlineEnter *" }, _G.packer_plugins)]]
