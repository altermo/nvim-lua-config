...
_G.packer_plugins = {
  ...
  ["bracey.vim"] = {
    ...
    needs_bufread = false,
    only_cond = false,
    path = "/home/user/.local/share/nvim/site/pack/packer/opt/bracey.vim",
  ...
  ["dial.nvim"] = {
    config = { "\27LJ\2\n—\1\0\0\a\0\v\0\0276\0\0\0'\2\1\0B\0\2\0026\1\0\0'\3\2\0B\1\2\0029\2\3\0'\4\4\0009\5\5\1B\5\1\0A\2\1\0019\2\3\0'\4\6\0009\5\a\1B\5\1\0A\2\1\0019\2\b\0'\4\4\0009\5\t\1B\5\1\0A\2\1\0019\2\b\0'\4\6\0009\5\n\1B\5\1\0A\2\1\1K\0\1\0\15dec_visual\15inc_visual\bxno\15dec_normal\n<C-x>\15inc_normal\n<C-a>\bnno\rdial.map\17utils.keymap\frequire\0" },
  ...
  ["hlchunk.nvim"] = {
    config = { 'require"hlchunk".setup{\n  blank = {\n    enable = false\n  },\n  chunk = {\n    enable = false\n  },\n  indent = {\n    chars = { "‚îÇ" }\n  },\n  line_num = {\n    enable = false\n  }\n}' },
    loaded = true,
    path = "/home/user/.local/share/nvim/site/pack/packer/start/hlchunk.nvim",
  ...
  ["neoswap.nvim"] = {
    config = { "\27LJ\2\n™\1\0\0\5\0\t\0\0196\0\0\0'\2\1\0B\0\2\0029\0\2\0004\2\0\0B\0\2\0016\0\0\0'\2\3\0B\0\2\0029\0\4\0\18\1\0\0'\3\5\0'\4\6\0B\1\3\1\18\1\0\0'\3\a\0'\4\b\0B\1\3\1K\0\1\0\25<cmd>NeoSwapPrev<cr>\a<w\25<cmd>NeoSwapNext<cr>\a>w\bnno\17utils.keymap\nsetup\fNeoSwap\frequire\0" },
    keys = { { "n", ">w" }, { "n", "<w" } },
    loaded = false,
    needs_bufread = false,
    only_cond = false,
    path = "/home/user/.local/share/nvim/site/pack/packer/opt/neoswap.nvim",
    url = "https://github.com/ecthelionvi/neoswap.nvim"
  },
  ["nightfox.nvim"] = {
    loaded = true,
  ...
  ["nvim-cmp"] = {
    after = { "cmp-async-path", "cmp-cmdline-history", "cmp-spell", "cmp-calc", "cmp-buffer", "cmp-cmdline", "cmp-rg", "cmp-nvim-lsp-signature-help", "cmp-nvim-lsp", "codeium.nvim" },
  ...
  ["rayso.nvim"] = {
    commands = { "Rayso" },
    config = { 'require"rayso".setup{}' },
    loaded = false,
    needs_bufread = false,
    only_cond = false,
    path = "/home/user/.local/share/nvim/site/pack/packer/opt/rayso.nvim",
  ...
  ["ts-node-action"] = {
    config = { "\27LJ\2\n{\0\0\6\0\t\0\0146\0\0\0'\2\1\0B\0\2\0029\1\2\0004\3\0\0B\1\2\0016\1\3\0009\1\4\0019\1\5\1'\3\6\0'\4\a\0009\5\b\0B\1\4\1K\0\1\0\16node_action\6K\6n\bset\vkeymap\bvim\nsetup\19ts-node-action\frequire\0" },
    keys = { { "n", "K" } },
    loaded = false,
    needs_bufread = false,
    only_cond = false,
    path = "/home/user/.local/share/nvim/site/pack/packer/opt/ts-node-action",
  ...
  ["yanky.nvim"] = {
    config = { "\27LJ\2\n™\2\0\0\5\0\14\0\"6\0\0\0'\2\1\0B\0\2\0029\0\2\0004\2\0\0B\0\2\0016\0\0\0'\2\3\0B\0\2\0029\1\4\0'\3\5\0'\4\6\0B\1\3\0019\1\4\0'\3\a\0'\4\b\0B\1\3\0019\1\t\0'\3\5\0'\4\6\0B\1\3\0019\1\t\0'\3\a\0'\4\b\0B\1\3\0019\1\4\0'\3\n\0'\4\v\0B\1\3\0019\1\4\0'\3\f\0'\4\r\0B\1\3\1K\0\1\0\31<Plug>(YankyCycleBackward)\n<A-P>\30<Plug>(YankyCycleForward)\n<A-p>\bxno\27<Plug>(YankyPutBefore)\6P\26<Plug>(YankyPutAfter)\6p\bnno\17utils.keymap\nsetup\nyanky\frequire\0" },
...
vim.cmd [[nnoremap <silent> <w <cmd>lua require("packer.load")({'neoswap.nvim'}, { keys = "<lt>w", prefix = "" }, _G.packer_plugins)<cr>]]
...
vim.cmd [[nnoremap <silent> >w <cmd>lua require("packer.load")({'neoswap.nvim'}, { keys = ">w", prefix = "" }, _G.packer_plugins)<cr>]]
...
vim.cmd [[nnoremap <silent> K <cmd>lua require("packer.load")({'ts-node-action'}, { keys = "K", prefix = "" }, _G.packer_plugins)<cr>]]
vim.cmd [[nnoremap <silent> <A-P> <cmd>lua require("packer.load")({'yanky.nvim'}, { keys = "<lt>A-P>", prefix = "" }, _G.packer_plugins)<cr>]]
...
vim.cmd [[au FileType markdown ++once lua require("packer.load")({'markdown-preview.nvim', 'easyread.nvim', 'obsidian.nvim'}, { ft = "markdown" }, _G.packer_plugins)]]
...
vim.cmd [[au User s1 ++once lua require("packer.load")({'lualine.nvim', 'rainbow-delimiters.nvim', 'pretty-fold.nvim', 'nvim-lspconfig', 'vim-hexokinase'}, { event = "User s1" }, _G.packer_plugins)]]
