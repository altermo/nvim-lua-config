...
_G.packer_plugins = {
  ...
  ["nvim-cmp"] = {
    after = { "nvim-snippy", "cmp-nvim-lsp-signature-help", "cmp-nvim-lua", "cmp-nvim-lsp", "cmp-cmdline-history", "cmp-snippy", "cmp-nvim-tags", "cmp-cmdline", "cmp-fuzzy-buffer", "cmp-fish", "cmp-treesitter", "cmp-path", "cmp-spell", "cmp-rg", "cmp-calc", "cmp-tabnine", "cmp-buffer" },
...
vim.cmd [[au User s1 ++once lua require("packer.load")({'stabilize.nvim', 'nvim-ts-rainbow', 'nvim-ts-context-commentstring', 'vim-im-select', 'vim-hexokinase', 'mkdir.nvim', 'nightfox.nvim', 'matchparen.nvim', 'lsp-colors.nvim', 'indent-blankline.nvim', 'hlargs.nvim', 'nvim-treesitter-pairs', 'nvim-lspconfig', 'oak', 'due.nvim', 'abbreinder.nvim', 'FixCursorHold.nvim', 'falcon'}, { event = "User s1" }, _G.packer_plugins)]]
