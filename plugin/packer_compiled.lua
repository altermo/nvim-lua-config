...
_G.packer_plugins = {
  ...
  ["nvim-cmp"] = {
    after = { "cmp-spell", "nvim-snippy", "cmp-rg", "cmp-treesitter", "cmp-async-path", "cmp-nvim-lsp-signature-help", "cmp-calc", "cmp-cmdline-history", "cmp-buffer", "cmp-nvim-lsp", "cmp-nvim-tags", "cmp-cmdline", "cmp-snippy" },
...
vim.cmd [[au FileType markdown ++once lua require("packer.load")({'markdown-preview.nvim', 'easyread.nvim', 'vim-markdown-toc', 'obsidian.nvim'}, { ft = "markdown" }, _G.packer_plugins)]]
...
vim.cmd [[au User s1 ++once lua require("packer.load")({'vim-hexokinase', 'rainbow-delimiters.nvim', 'nvim-lspconfig', 'nightfox.nvim', 'hlargs.nvim', 'matchparen.nvim', 'due.nvim', 'indent-blankline.nvim', 'github-nvim-theme'}, { event = "User s1" }, _G.packer_plugins)]]
