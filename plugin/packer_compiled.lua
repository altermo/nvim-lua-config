...
_G.packer_plugins = {
  ...
  ["nvim-cmp"] = {
    after = { "cmp-tabnine", "cmp-nvim-tags", "cmp-calc", "cmp-fish", "cmp-nvim-lsp-signature-help", "cmp-path", "cmp-rg", "cmp-snippy", "cmp-nvim-lsp", "cmp-buffer", "cmp-spell", "codeium.nvim", "cmp-nvim-lua", "nvim-snippy", "cmp-cmdline-history", "cmp-cmdline", "cmp-treesitter" },
...
vim.cmd [[au FileType markdown ++once lua require("packer.load")({'markdown-preview.nvim', 'mkdnflow.nvim', 'easyread.nvim', 'vim-markdown-toc'}, { ft = "markdown" }, _G.packer_plugins)]]
...
vim.cmd [[au User s1 ++once lua require("packer.load")({'lsp-colors.nvim', 'indent-blankline.nvim', 'hlargs.nvim', 'due.nvim', 'oak', 'nvim-ts-rainbow2', 'nvim-treesitter-pairs', 'nvim-lspconfig', 'vim-hexokinase', 'nightfox.nvim', 'matchparen.nvim', 'vim-im-select', 'nvim-ts-context-commentstring', 'falcon'}, { event = "User s1" }, _G.packer_plugins)]]
