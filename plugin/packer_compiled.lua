...
_G.packer_plugins = {
  ...
  ["nvim-cmp"] = {
    after = { "cmp-nvim-lsp", "cmp-cmdline", "cmp-fish", "cmp-calc", "cmp-cmdline-history", "cmp-fuzzy-buffer", "cmp-nvim-lua", "cmp-treesitter", "cmp-nvim-lsp-signature-help", "cmp-buffer", "cmp-path", "cmp-tabnine", "nvim-snippy", "cmp-rg", "cmp-spell", "cmp-snippy", "cmp-nvim-tags" },
...
vim.cmd [[au FileType markdown ++once lua require("packer.load")({'mkdnflow.nvim', 'vim-markdown-toc', 'markdown-preview.nvim'}, { ft = "markdown" }, _G.packer_plugins)]]
...
vim.cmd [[au CmdlineEnter * ++once lua require("packer.load")({'range-highlight.nvim', 'numb.nvim', 'nvim-cmp', 'nvim-hlslens'}, { event = "CmdlineEnter *" }, _G.packer_plugins)]]
vim.cmd [[au User s1 ++once lua require("packer.load")({'indent-blankline.nvim', 'hlargs.nvim', 'mkdir.nvim', 'matchparen.nvim', 'lsp-colors.nvim', 'stabilize.nvim', 'nightfox.nvim', 'oak', 'nvim-ts-rainbow', 'nvim-ts-context-commentstring', 'due.nvim', 'nvim-lspconfig', 'falcon', 'FixCursorHold.nvim', 'vim-im-select', 'abbreinder.nvim', 'nvim-treesitter-pairs', 'vim-hexokinase'}, { event = "User s1" }, _G.packer_plugins)]]
