...
_G.packer_plugins = {
  ...
  ["nvim-cmp"] = {
    after = { "cmp-async-path", "codeium.nvim", "cmp-spell", "cmp-nvim-lsp", "cmp-nvim-lsp-signature-help", "cmp-buffer", "cmp-rg", "cmp-calc", "cmp-cmdline", "cmp-cmdline-history" },
...
vim.cmd [[au User s1 ++once lua require("packer.load")({'nvim-lspconfig', 'rainbow-delimiters.nvim', 'lualine.nvim', 'indent-blankline.nvim', 'due.nvim'}, { event = "User s1" }, _G.packer_plugins)]]
