...
_G.packer_plugins = {
  ...
  ["nvim-cmp"] = {
    after = { "codeium.nvim", "nvim-snippy", "cmp-tabnine", "cmp-nvim-lua", "cmp-nvim-tags", "cmp-rg", "cmp-snippy", "cmp-spell", "cmp-buffer", "cmp-path", "cmp-cmdline-history", "cmp-nvim-lsp", "cmp-nvim-lsp-signature-help", "cmp-cmdline", "cmp-calc", "cmp-treesitter" },
...
vim.cmd [[au CmdlineEnter * ++once lua require("packer.load")({'numb.nvim', 'range-highlight.nvim', 'nvim-cmp'}, { event = "CmdlineEnter *" }, _G.packer_plugins)]]
...
vim.cmd [[au User s1 ++once lua require("packer.load")({'nightfox.nvim', 'indent-blankline.nvim', 'falcon', 'lsp-colors.nvim', 'hlargs.nvim', 'due.nvim', 'vim-im-select', 'vim-hexokinase', 'oak', 'nvim-ts-rainbow2', 'matchparen.nvim', 'nvim-ts-context-commentstring', 'nvim-lspconfig'}, { event = "User s1" }, _G.packer_plugins)]]
