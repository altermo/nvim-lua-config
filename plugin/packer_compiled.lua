...
_G.packer_plugins = {
  ...
  ["colorful-winsep.nvim"] = {
    ...
    needs_bufread = false,
    only_cond = false,
    path = "/home/user/.local/share/nvim/site/pack/packer/opt/colorful-winsep.nvim",
  ...
  ["easy-action"] = {
    loaded = false,
    needs_bufread = false,
    path = "/home/user/.local/share/nvim/site/pack/packer/opt/easy-action",
    url = "https://github.com/weissle/easy-action"
  },
  ["easypick.nvim"] = {
    loaded = true,
    path = "/home/user/.local/share/nvim/site/pack/packer/start/easypick.nvim",
  ...
  ["mind.nvim"] = {
    loaded = true,
    path = "/home/user/.local/share/nvim/site/pack/packer/start/mind.nvim",
  ...
  ["no-neck-pain.nvim"] = {
    ...
    needs_bufread = false,
    only_cond = false,
    path = "/home/user/.local/share/nvim/site/pack/packer/opt/no-neck-pain.nvim",
  ...
  ["nvim-cmp"] = {
    after = { "cmp-fuzzy-buffer", "cmp-nvim-lsp-signature-help", "cmp-treesitter", "cmp-cmdline-history", "cmp-snippy", "cmp-nvim-tags", "cmp-nvim-lua", "cmp-buffer", "cmp-calc", "cmp-nvim-lsp", "cmp-cmdline", "cmp-spell", "cmp-tabnine", "nvim-snippy", "cmp-rg", "cmp-fish", "cmp-path" },
  ...
  ["nvim-recorder"] = {
    config = { 'require"recorder".setup{\n  slots = { "a", "b", "c" }\n}' },
    keys = { { "n", "q" }, { "n", "Q" }, { "n", "cq" }, { "n", "yq" }, { "n", "<C-q>" } },
    loaded = false,
    needs_bufread = false,
    only_cond = false,
    path = "/home/user/.local/share/nvim/site/pack/packer/opt/nvim-recorder",
  ...
  ["stylish.nvim"] = {
    loaded = true,
    path = "/home/user/.local/share/nvim/site/pack/packer/start/stylish.nvim",
  ...
  ["syntax-tree-surfer"] = {
    ...
    keys = { { "n", "vx" }, { "n", "vn" }, { "n", "<A-j>" }, { "n", "<A-k>" }, { "n", "<A-S-k>" }, { "n", "<A-S-j>" }, { "n", "gF" }, { "x", "<C-j>" }, { "x", "<C-k>" }, { "x", "<C-h>" }, { "x", "<C-l>" }, { "x", "<C-S-h>" }, { "x", "<C-S-j>" }, { "x", "<C-S-k>" }, { "x", "<C-S-l>" }, { "x", "<A-k>" }, { "x", "<A-j>" } },
    loaded = false,
    needs_bufread = false,
    only_cond = false,
  ...
  ["telescope-rooter.nvim"] = {
    loaded = true,
    path = "/home/user/.local/share/nvim/site/pack/packer/start/telescope-rooter.nvim",
  ...
  treesj = {
    config = { "\27LJ\2\nê\1\0\0\5\0\b\0\0146\0\0\0'\2\1\0B\0\2\0029\1\2\0005\3\3\0B\1\2\0016\1\0\0'\3\4\0B\1\2\0029\1\5\1'\3\6\0'\4\a\0B\1\3\1K\0\1\0\20<cmd>TSJToggle\n\agS\bnno\17utils.keymap\1\0\1\24use_default_keymaps\1\nsetup\vtreesj\frequire\0" },
    keys = { { "n", "gS" } },
    loaded = false,
    needs_bufread = false,
    only_cond = false,
    path = "/home/user/.local/share/nvim/site/pack/packer/opt/treesj",
...
try_loadstring("\27LJ\2\nπ\2\0\1\a\0\6\0\v6\1\0\0009\1\1\0019\1\2\1\18\3\0\0'\4\3\0\18\5\0\0'\6\4\0&\4\6\0045\5\5\0B\1\4\1K\0\1\0\1\0\4\nnargs\6*\rcomplete\tfile\nrange\2\tbang\2Z\",l1=<line1>,l2=<line2>,bang=<q-bang>,args=<q-args>,mods=\"<mods>\"},_G.packer_plugins)mlua require\"packer.load\"({\"vim-fugitive\"},{},_G.packer_plugins)\nrequire\"packer.load\"({\"vim-flog\"},{cmd=\"\29nvim_create_user_command\bapi\bvimK\1\0\4\0\4\0\v3\0\0\0\18\1\0\0'\3\1\0B\1\2\1\18\1\0\0'\3\2\0B\1\2\1\18\1\0\0'\3\3\0B\1\2\1K\0\1\0\fFloggit\14Flogsplit\tFlog\0\0", "setup", "vim-flog")
...
pcall(vim.api.nvim_create_user_command, 'NoNeckPain', function(cmdargs)
          require('packer.load')({'no-neck-pain.nvim'}, { cmd = 'NoNeckPain', l1 = cmdargs.line1, l2 = cmdargs.line2, bang = cmdargs.bang, args = cmdargs.args, mods = cmdargs.mods }, _G.packer_plugins)
        end,
        {nargs = '*', range = true, bang = true, complete = function()
          require('packer.load')({'no-neck-pain.nvim'}, {}, _G.packer_plugins)
          return vim.fn.getcompletion('NoNeckPain ', 'cmdline')
      end})
...
vim.cmd [[nnoremap <silent> Q <cmd>lua require("packer.load")({'nvim-recorder'}, { keys = "Q", prefix = "" }, _G.packer_plugins)<cr>]]
...
vim.cmd [[nnoremap <silent> gd <cmd>lua require("packer.load")({'nvim-treesitter-refactor'}, { keys = "gd", prefix = "" }, _G.packer_plugins)<cr>]]
...
vim.cmd [[nnoremap <silent> yq <cmd>lua require("packer.load")({'nvim-recorder'}, { keys = "yq", prefix = "" }, _G.packer_plugins)<cr>]]
...
vim.cmd [[nnoremap <silent> gS <cmd>lua require("packer.load")({'treesj'}, { keys = "gS", prefix = "" }, _G.packer_plugins)<cr>]]
...
vim.cmd [[nnoremap <silent> <C-q> <cmd>lua require("packer.load")({'nvim-recorder'}, { keys = "<lt>C-q>", prefix = "" }, _G.packer_plugins)<cr>]]
...
vim.cmd [[nnoremap <silent> cq <cmd>lua require("packer.load")({'nvim-recorder'}, { keys = "cq", prefix = "" }, _G.packer_plugins)<cr>]]
...
vim.cmd [[au FileType puml ++once lua require("packer.load")({'vim-slumlord', 'plantuml-syntax', 'plantuml-previewer.vim', 'open-browser.vim'}, { ft = "puml" }, _G.packer_plugins)]]
...
vim.cmd [[au FileType markdown ++once lua require("packer.load")({'vim-markdown-toc', 'mkdnflow.nvim', 'markdown-preview.nvim'}, { ft = "markdown" }, _G.packer_plugins)]]
...
vim.cmd [[au ModeChanged * ++once lua require("packer.load")({'modicator.nvim'}, { event = "ModeChanged *" }, _G.packer_plugins)]]
vim.cmd [[au TextYankPost * ++once lua require("packer.load")({'yanky.nvim'}, { event = "TextYankPost *" }, _G.packer_plugins)]]
vim.cmd [[au WinNew * ++once lua require("packer.load")({'colorful-winsep.nvim'}, { event = "WinNew *" }, _G.packer_plugins)]]
vim.cmd [[au InsertEnter * ++once lua require("packer.load")({'nvim-cmp', 'nvim-treesitter-endwise'}, { event = "InsertEnter *" }, _G.packer_plugins)]]
vim.cmd [[au CmdlineEnter * ++once lua require("packer.load")({'nvim-cmp', 'nvim-hlslens', 'numb.nvim', 'range-highlight.nvim'}, { event = "CmdlineEnter *" }, _G.packer_plugins)]]
vim.cmd [[au User s1 ++once lua require("packer.load")({'falcon', 'nvim-treesitter-pairs', 'nvim-lspconfig', 'vim-im-select', 'vim-hexokinase', 'nightfox.nvim', 'matchparen.nvim', 'lsp-colors.nvim', 'stabilize.nvim', 'indent-blankline.nvim', 'hlargs.nvim', 'abbreinder.nvim', 'FixCursorHold.nvim', 'due.nvim', 'mkdir.nvim', 'oak', 'nvim-ts-rainbow', 'nvim-ts-context-commentstring'}, { event = "User s1" }, _G.packer_plugins)]]
