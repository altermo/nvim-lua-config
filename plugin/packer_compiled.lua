...
_G.packer_plugins = {
  ...
  ["context.vim"] = {
    loaded = true,
    path = "/home/user/.local/share/nvim/site/pack/packer/start/context.vim",
  ...
  ["focus.nvim"] = {
    config = { 'require("focus").setup({autoresize=false})' },
    loaded = true,
  ...
  ["lualine.nvim"] = {
    config = { 'require"lualine".setup({options={theme="powerline"}})' },
    loaded = true,
  ...
  ["vim-smoothie"] = {
    loaded = true,
    path = "/home/user/.local/share/nvim/site/pack/packer/start/vim-smoothie",
