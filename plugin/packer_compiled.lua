...
_G.packer_plugins = {
  ...
  ["nvim-cmp"] = {
    after = { "cmp-spell", "cmp-cmdline", "cmp-fuzzy-buffer", "cmp-snippy", "cmp-calc", "cmp-path", "cmp-treesitter", "cmp-nvim-lsp", "cmp-cmdline-history", "cmp-buffer", "cmp-rg", "cmp-tabnine", "cmp-fish", "cmp-nvim-lua", "nvim-snippy", "cmp-nvim-tags", "cmp-nvim-lsp-signature-help" },
...
vim.cmd [[au CmdlineEnter * ++once lua require("packer.load")({'numb.nvim', 'nvim-cmp', 'nvim-hlslens', 'range-highlight.nvim'}, { event = "CmdlineEnter *" }, _G.packer_plugins)]]
vim.cmd [[au InsertEnter * ++once lua require("packer.load")({'nvim-cmp'}, { event = "InsertEnter *" }, _G.packer_plugins)]]
vim.cmd [[au User s1 ++once lua require("packer.load")({'oak', 'nightfox.nvim', 'nvim-ts-rainbow', 'nvim-ts-context-commentstring', 'mkdir.nvim', 'lsp-colors.nvim', 'hlargs.nvim', 'due.nvim', 'vim-im-select', 'vim-hexokinase', 'stabilize.nvim', 'abbreinder.nvim', 'FixCursorHold.nvim', 'nvim-treesitter-pairs', 'falcon', 'matchparen.nvim', 'nvim-lspconfig'}, { event = "User s1" }, _G.packer_plugins)]]
