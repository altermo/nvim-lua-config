...
_G.packer_plugins = {
  ...
  ["nvim-cmp"] = {
    after = { "cmp-cmdline-history", "cmp-fish", "cmp-nvim-lsp-signature-help", "cmp-path", "cmp-rg", "cmp-tabnine", "codeium.nvim", "nvim-snippy", "cmp-snippy", "cmp-nvim-lsp", "cmp-nvim-lua", "cmp-treesitter", "cmp-buffer", "cmp-spell", "cmp-nvim-tags", "cmp-calc", "cmp-cmdline" },
...
vim.cmd [[au FileType puml ++once lua require("packer.load")({'vim-slumlord', 'open-browser.vim', 'plantuml-previewer.vim', 'plantuml-syntax'}, { ft = "puml" }, _G.packer_plugins)]]
...
vim.cmd [[au FileType markdown ++once lua require("packer.load")({'markdown-preview.nvim', 'mkdnflow.nvim', 'vim-markdown-toc', 'easyread.nvim'}, { ft = "markdown" }, _G.packer_plugins)]]
time([[Defining lazy-load filetype autocommands]], false)
  -- Event lazy-loads
time([[Defining lazy-load event autocommands]], true)
vim.cmd [[au TextYankPost * ++once lua require("packer.load")({'yanky.nvim'}, { event = "TextYankPost *" }, _G.packer_plugins)]]
vim.cmd [[au InsertEnter * ++once lua require("packer.load")({'abbreinder.nvim', 'nvim-treesitter-endwise', 'nvim-cmp'}, { event = "InsertEnter *" }, _G.packer_plugins)]]
vim.cmd [[au WinNew * ++once lua require("packer.load")({'colorful-winsep.nvim'}, { event = "WinNew *" }, _G.packer_plugins)]]
vim.cmd [[au User s1 ++once lua require("packer.load")({'hlargs.nvim', 'indent-blankline.nvim', 'lsp-colors.nvim', 'matchparen.nvim', 'falcon', 'nvim-lspconfig', 'nightfox.nvim', 'due.nvim', 'nvim-treesitter-pairs', 'vim-hexokinase', 'nvim-ts-context-commentstring', 'nvim-ts-rainbow2', 'vim-im-select', 'oak'}, { event = "User s1" }, _G.packer_plugins)]]
...
vim.cmd [[au CmdlineEnter * ++once lua require("packer.load")({'range-highlight.nvim', 'numb.nvim', 'nvim-hlslens', 'nvim-cmp'}, { event = "CmdlineEnter *" }, _G.packer_plugins)]]
