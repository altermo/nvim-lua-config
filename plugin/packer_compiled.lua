...
_G.packer_plugins = {
  ...
  ["nvim-cmp"] = {
    after = { "nvim-snippy", "cmp-calc", "cmp-treesitter", "cmp-rg", "cmp-spell", "cmp-buffer", "cmp-nvim-lsp-signature-help", "codeium.nvim", "cmp-async-path", "cmp-cmdline", "cmp-cmdline-history", "cmp-snippy", "cmp-nvim-lsp", "cmp-nvim-tags" },
...
vim.cmd [[au FileType markdown ++once lua require("packer.load")({'obsidian.nvim', 'markdown-preview.nvim', 'easyread.nvim', 'vim-markdown-toc'}, { ft = "markdown" }, _G.packer_plugins)]]
...
vim.cmd [[au User s1 ++once lua require("packer.load")({'rainbow-delimiters.nvim', 'nvim-lspconfig', 'matchparen.nvim', 'indent-blankline.nvim', 'hlargs.nvim', 'lualine.nvim', 'due.nvim', 'vim-hexokinase'}, { event = "User s1" }, _G.packer_plugins)]]
