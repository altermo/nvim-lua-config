...
_G.packer_plugins = {
  ...
  ["nvim-cmp"] = {
    after = { "nvim-snippy", "cmp-tabnine", "cmp-rg", "cmp-nvim-tags", "cmp-path", "cmp-buffer", "cmp-fuzzy-buffer", "cmp-snippy", "cmp-cmdline-history", "cmp-nvim-lsp", "cmp-calc", "cmp-nvim-lua", "cmp-treesitter", "cmp-fish", "cmp-cmdline", "cmp-nvim-lsp-signature-help", "cmp-spell" },
...
vim.cmd [[au User s1 ++once lua require("packer.load")({'matchparen.nvim', 'oak', 'nvim-ts-rainbow', 'nvim-ts-context-commentstring', 'nvim-lspconfig', 'lsp-colors.nvim', 'falcon', 'nightfox.nvim', 'mkdir.nvim', 'due.nvim', 'stabilize.nvim', 'vim-im-select', 'nvim-treesitter-pairs', 'vim-hexokinase', 'indent-blankline.nvim', 'abbreinder.nvim', 'hlargs.nvim', 'FixCursorHold.nvim'}, { event = "User s1" }, _G.packer_plugins)]]
