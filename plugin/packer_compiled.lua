...
_G.packer_plugins = {
  ...
  ["abbremand.nvim"] = {
    ...
    needs_bufread = false,
    only_cond = false,
    path = "/home/user/.local/share/nvim/site/pack/packer/opt/abbremand.nvim",
  ...
  ["conceal.nvim"] = {
    loaded = false,
    needs_bufread = false,
    path = "/home/user/.local/share/nvim/site/pack/packer/opt/conceal.nvim",
  ...
  ["fzf-folds.vim"] = {
    commands = { "Folds" },
    config = { "\27LJ\2\n~\0\0\3\0\3\0\0056\0\0\0009\0\1\0'\2\2\0B\0\2\1K\0\1\0_if g:loaded_fzf==1\nunlet g:loaded_fzf\nsource /usr/share/vim/vimfiles/plugin/fzf.vim\nendif\n\bcmd\bvim\0" },
    loaded = false,
    needs_bufread = false,
    only_cond = false,
  ...
  ["indent-blankline.nvim"] = {
    config = { "\27LJ\2\n°\1\0\0\3\0\b\0\v6\0\0\0'\2\1\0B\0\2\0029\0\2\0005\2\3\0B\0\2\0016\0\4\0009\0\5\0005\1\a\0=\1\6\0K\0\1\0\1\2\0\0\14dashboard&indent_blankline_filetype_exclude\6g\bvim\1\0\1\25show_current_context\2\nsetup\21indent_blankline\frequire\0" },
    loaded = false,
    needs_bufread = false,
    only_cond = false,
  ...
  ["lista.nvim"] = {
    commands = { "Lista" },
    config = { "\27LJ\2\nò\1\0\0\3\0\3\0\0056\0\0\0009\0\1\0'\2\2\0B\0\2\1K\0\1\0yif g:loaded_remote_plugins==1\nunlet g:loaded_remote_plugins\nsource /usr/share/nvim/runtime/plugin/rplugin.vim\nendif\n\bcmd\bvim\0" },
    loaded = false,
    needs_bufread = false,
    only_cond = false,
  ...
  ["lspkind.nvim"] = {
    ...
    needs_bufread = false,
    only_cond = false,
    path = "/home/user/.local/share/nvim/site/pack/packer/opt/lspkind.nvim",
  ...
  ["mind.nvim"] = {
    loaded = false,
    needs_bufread = false,
    path = "/home/user/.local/share/nvim/site/pack/packer/opt/mind.nvim",
  ...
  ["nvim-cmp"] = {
    after = { "nvim-snippy", "cmp-nvim-tags", "cmp-buffer", "cmp-nvim-lsp", "cmp-path", "cmp-cmdline-history", "cmp-nvim-lua", "cmp-calc", "cmp-spell", "cmp-nvim-lsp-signature-help", "cmp-snippy", "cmp-fish", "codeium.nvim", "cmp-treesitter", "cmp-rg", "cmp-cmdline", "cmp-tabnine" },
  ...
  ["nvim-ts-rainbow2"] = {
    ...
    needs_bufread = false,
    only_cond = false,
    path = "/home/user/.local/share/nvim/site/pack/packer/opt/nvim-ts-rainbow2",
  ...
  sonokai = {
    loaded = true,
    path = "/home/user/.local/share/nvim/site/pack/packer/start/sonokai",
  ...
  ["ssr.nvim"] = {
    config = { "\27LJ\2\n}\0\0\a\0\t\0\0176\0\0\0'\2\1\0B\0\2\0029\0\2\0004\2\0\0B\0\2\0016\0\3\0009\0\4\0009\0\5\0005\2\6\0'\3\a\0006\4\0\0'\6\1\0B\4\2\0029\4\b\4B\0\4\1K\0\1\0\topen\b\\sr\1\3\0\0\6n\6x\bset\vkeymap\bvim\nsetup\bssr\frequire\0" },
    keys = { { "n", "\\sr" }, { "x", "\\sr" } },
    loaded = false,
    needs_bufread = false,
    only_cond = false,
  ...
  ["vim-colors-pencil"] = {
    loaded = true,
    path = "/home/user/.local/share/nvim/site/pack/packer/start/vim-colors-pencil",
  ...
  ["vim-felipec"] = {
    loaded = true,
    path = "/home/user/.local/share/nvim/site/pack/packer/start/vim-felipec",
...
vim.cmd [[nnoremap <silent> \sr <cmd>lua require("packer.load")({'ssr.nvim'}, { keys = "\\sr", prefix = "" }, _G.packer_plugins)<cr>]]
...
vim.cmd [[xnoremap <silent> \sr <cmd>lua require("packer.load")({'ssr.nvim'}, { keys = "\\sr", prefix = "" }, _G.packer_plugins)<cr>]]
...
vim.cmd [[au FileType puml ++once lua require("packer.load")({'open-browser.vim', 'vim-slumlord', 'plantuml-syntax', 'plantuml-previewer.vim'}, { ft = "puml" }, _G.packer_plugins)]]
...
vim.cmd [[au FileType markdown ++once lua require("packer.load")({'mkdnflow.nvim', 'markdown-preview.nvim', 'vim-markdown-toc', 'easyread.nvim'}, { ft = "markdown" }, _G.packer_plugins)]]
vim.cmd [[au FileType org ++once lua require("packer.load")({'orgmode'}, { ft = "org" }, _G.packer_plugins)]]
time([[Defining lazy-load filetype autocommands]], false)
  -- Event lazy-loads
time([[Defining lazy-load event autocommands]], true)
vim.cmd [[au InsertEnter * ++once lua require("packer.load")({'nvim-treesitter-endwise', 'nvim-cmp', 'abbreinder.nvim'}, { event = "InsertEnter *" }, _G.packer_plugins)]]
vim.cmd [[au User s1 ++once lua require("packer.load")({'oak', 'nvim-ts-rainbow2', 'lsp-colors.nvim', 'indent-blankline.nvim', 'due.nvim', 'nightfox.nvim', 'vim-im-select', 'vim-hexokinase', 'nvim-ts-context-commentstring', 'falcon', 'hlargs.nvim', 'matchparen.nvim', 'nvim-lspconfig'}, { event = "User s1" }, _G.packer_plugins)]]
...
vim.cmd [[au CmdlineEnter * ++once lua require("packer.load")({'nvim-hlslens', 'nvim-cmp', 'numb.nvim', 'range-highlight.nvim'}, { event = "CmdlineEnter *" }, _G.packer_plugins)]]
...
vim.cmd[[au FuncUndefined FugitiveIsGitDir ++once lua require("packer.load")({'vim-fugitive'}, {}, _G.packer_plugins)]]
