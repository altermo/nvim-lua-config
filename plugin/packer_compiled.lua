...
_G.packer_plugins = {
  ...
  ["nvim-cmp"] = {
    after = { "cmp-tabnine", "nvim-snippy", "cmp-spell", "cmp-fish", "cmp-nvim-lua", "cmp-nvim-tags", "cmp-treesitter", "cmp-rg", "cmp-cmdline-history", "codeium.nvim", "cmp-path", "cmp-nvim-lsp-signature-help", "cmp-buffer", "cmp-snippy", "cmp-nvim-lsp", "cmp-calc", "cmp-cmdline" },
...
vim.cmd [[au FileType markdown ++once lua require("packer.load")({'vim-markdown-toc', 'mkdnflow.nvim', 'easyread.nvim', 'markdown-preview.nvim'}, { ft = "markdown" }, _G.packer_plugins)]]
...
vim.cmd [[au User s1 ++once lua require("packer.load")({'nightfox.nvim', 'vim-hexokinase', 'oak', 'falcon', 'indent-blankline.nvim', 'due.nvim', 'nvim-ts-rainbow2', 'nvim-ts-context-commentstring', 'vim-im-select', 'lsp-colors.nvim', 'matchparen.nvim', 'nvim-lspconfig', 'hlargs.nvim'}, { event = "User s1" }, _G.packer_plugins)]]
...
vim.cmd [[au CmdlineEnter * ++once lua require("packer.load")({'numb.nvim', 'range-highlight.nvim', 'nvim-cmp', 'nvim-hlslens'}, { event = "CmdlineEnter *" }, _G.packer_plugins)]]
