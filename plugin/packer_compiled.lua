...
_G.packer_plugins = {
  ...
  ["nvim-cmp"] = {
    after = { "cmp-spell", "cmp-rg", "nvim-snippy", "cmp-fuzzy-buffer", "cmp-path", "cmp-snippy", "cmp-cmdline-history", "cmp-cmdline", "cmp-buffer", "cmp-nvim-lsp", "cmp-nvim-lsp-signature-help", "cmp-nvim-lua", "cmp-treesitter", "cmp-nvim-tags", "cmp-fish", "cmp-calc", "cmp-tabnine" },
  ...
  ["vim-smalls"] = {
    ...
    config = { "\27LJ\2\n†\1\0\0\2\0\6\0\r6\0\0\0009\0\1\0)\1\1\0=\1\2\0006\0\0\0009\0\1\0)\1\1\0=\1\3\0006\0\0\0009\0\1\0'\1\5\0=\1\4\0K\0\1\0\31ABCDEFGHIJKLMNOPQRSTUVWXYZ\21smalls_jump_keys&smalls_auto_jump_min_input_length\21smalls_auto_jump\6g\bvim\0" },
    loaded = false,
    needs_bufread = false,
    only_cond = false,
...
vim.cmd [[au CmdlineEnter * ++once lua require("packer.load")({'nvim-hlslens', 'numb.nvim', 'range-highlight.nvim', 'nvim-cmp'}, { event = "CmdlineEnter *" }, _G.packer_plugins)]]
vim.cmd [[au User s1 ++once lua require("packer.load")({'oak', 'hlargs.nvim', 'nvim-ts-context-commentstring', 'vim-im-select', 'due.nvim', 'falcon', 'nightfox.nvim', 'abbreinder.nvim', 'FixCursorHold.nvim', 'mkdir.nvim', 'matchparen.nvim', 'nvim-treesitter-pairs', 'stabilize.nvim', 'vim-hexokinase', 'nvim-lspconfig', 'indent-blankline.nvim', 'nvim-ts-rainbow', 'lsp-colors.nvim'}, { event = "User s1" }, _G.packer_plugins)]]
