...
_G.packer_plugins = {
  ...
  ["nvim-cmp"] = {
    after = { "cmp-buffer", "codeium.nvim", "cmp-nvim-lsp", "cmp-nvim-tags", "cmp-calc", "cmp-snippy", "cmp-tabnine", "cmp-async-path", "cmp-treesitter", "nvim-snippy", "cmp-cmdline", "cmp-cmdline-history", "cmp-spell", "cmp-rg", "cmp-nvim-lsp-signature-help" },
...
vim.cmd [[au User s1 ++once lua require("packer.load")({'nvim-lspconfig', 'github-nvim-theme', 'nightfox.nvim', 'due.nvim', 'indent-blankline.nvim', 'hlargs.nvim', 'matchparen.nvim', 'vim-hexokinase', 'rainbow-delimiters.nvim'}, { event = "User s1" }, _G.packer_plugins)]]
