...
_G.packer_plugins = {
  ...
  ["nvim-cmp"] = {
    after = { "cmp-cmdline-history", "cmp-nvim-lua", "cmp-nvim-tags", "cmp-cmdline", "cmp-path", "cmp-spell", "cmp-rg", "codeium.nvim", "cmp-fish", "cmp-buffer", "cmp-snippy", "cmp-calc", "cmp-nvim-lsp-signature-help", "cmp-tabnine", "cmp-treesitter", "cmp-nvim-lsp", "nvim-snippy" },
...
vim.cmd [[au FileType markdown ++once lua require("packer.load")({'markdown-preview.nvim', 'easyread.nvim', 'mkdnflow.nvim', 'vim-markdown-toc'}, { ft = "markdown" }, _G.packer_plugins)]]
...
vim.cmd [[au User s1 ++once lua require("packer.load")({'oak', 'nvim-ts-context-commentstring', 'matchparen.nvim', 'lsp-colors.nvim', 'nvim-lspconfig', 'falcon', 'indent-blankline.nvim', 'hlargs.nvim', 'nightfox.nvim', 'due.nvim', 'vim-im-select', 'vim-hexokinase', 'nvim-ts-rainbow2'}, { event = "User s1" }, _G.packer_plugins)]]
