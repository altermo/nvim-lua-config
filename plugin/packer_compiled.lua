...
_G.packer_plugins = {
  ...
  ["nvim-cmp"] = {
    after = { "cmp-treesitter", "cmp-fish", "cmp-tabnine", "nvim-snippy", "cmp-rg", "cmp-snippy", "cmp-path", "cmp-nvim-lsp", "cmp-spell", "cmp-nvim-lsp-signature-help", "cmp-nvim-lua", "cmp-buffer", "cmp-calc", "codeium.nvim", "cmp-nvim-tags", "cmp-cmdline-history", "cmp-cmdline" },
...
vim.cmd [[au User s1 ++once lua require("packer.load")({'oak', 'nvim-ts-rainbow2', 'vim-im-select', 'lsp-colors.nvim', 'matchparen.nvim', 'due.nvim', 'falcon', 'hlargs.nvim', 'nightfox.nvim', 'nvim-ts-context-commentstring', 'nvim-lspconfig', 'indent-blankline.nvim', 'vim-hexokinase'}, { event = "User s1" }, _G.packer_plugins)]]
