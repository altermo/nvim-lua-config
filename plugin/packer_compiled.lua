...
_G.packer_plugins = {
  ...
  ["flash.nvim"] = {
    ...
    needs_bufread = false,
    only_cond = false,
    path = "/home/user/.local/share/nvim/site/pack/packer/opt/flash.nvim",
  ...
  ["nvim-cmp"] = {
    after = { "cmp-treesitter", "cmp-calc", "cmp-snippy", "cmp-spell", "cmp-rg", "cmp-buffer", "cmp-async-path", "codeium.nvim", "cmp-cmdline-history", "cmp-cmdline", "cmp-nvim-tags", "cmp-nvim-lsp-signature-help", "nvim-snippy", "cmp-nvim-lsp" },
...
vim.cmd [[au FileType markdown ++once lua require("packer.load")({'vim-markdown-toc', 'easyread.nvim', 'obsidian.nvim', 'markdown-preview.nvim'}, { ft = "markdown" }, _G.packer_plugins)]]
...
vim.cmd [[au User s1 ++once lua require("packer.load")({'nightfox.nvim', 'matchparen.nvim', 'vim-hexokinase', 'indent-blankline.nvim', 'hlargs.nvim', 'github-nvim-theme', 'rainbow-delimiters.nvim', 'nvim-lspconfig', 'due.nvim'}, { event = "User s1" }, _G.packer_plugins)]]
