...
_G.packer_plugins = {
  ...
  ["nvim-cmp"] = {
    after = { "cmp-rg", "cmp-fish", "cmp-treesitter", "cmp-tabnine", "nvim-snippy", "cmp-spell", "cmp-nvim-lua", "cmp-snippy", "cmp-cmdline-history", "cmp-calc", "cmp-cmdline", "cmp-buffer", "cmp-nvim-lsp", "cmp-nvim-lsp-signature-help", "codeium.nvim", "cmp-nvim-tags", "cmp-path" },
...
vim.cmd [[au FileType puml ++once lua require("packer.load")({'open-browser.vim', 'plantuml-previewer.vim', 'vim-slumlord', 'plantuml-syntax'}, { ft = "puml" }, _G.packer_plugins)]]
...
vim.cmd [[au InsertEnter * ++once lua require("packer.load")({'nvim-cmp', 'nvim-treesitter-endwise', 'abbreinder.nvim'}, { event = "InsertEnter *" }, _G.packer_plugins)]]
...
vim.cmd [[au User s1 ++once lua require("packer.load")({'indent-blankline.nvim', 'nvim-ts-rainbow2', 'falcon', 'nvim-ts-context-commentstring', 'nvim-lspconfig', 'lsp-colors.nvim', 'oak', 'matchparen.nvim', 'nightfox.nvim', 'hlargs.nvim', 'vim-hexokinase', 'vim-im-select', 'due.nvim'}, { event = "User s1" }, _G.packer_plugins)]]
