...
_G.packer_plugins = {
  ...
  ["nvim-cmp"] = {
    after = { "cmp-tabnine", "cmp-cmdline-history", "cmp-nvim-tags", "cmp-async-path", "codeium.nvim", "cmp-nvim-lsp-signature-help", "cmp-snippy", "cmp-buffer", "cmp-treesitter", "cmp-rg", "cmp-calc", "cmp-spell", "cmp-cmdline", "cmp-nvim-lsp", "nvim-snippy" },
  ...
  ["vim-enfocado"] = {
    loaded = true,
    path = "/home/user/.local/share/nvim/site/pack/packer/start/vim-enfocado",
...
vim.cmd [[au FileType markdown ++once lua require("packer.load")({'obsidian.nvim', 'mkdnflow.nvim', 'markdown-preview.nvim', 'vim-markdown-toc', 'easyread.nvim'}, { ft = "markdown" }, _G.packer_plugins)]]
...
vim.cmd [[au User s1 ++once lua require("packer.load")({'vim-hexokinase', 'indent-blankline.nvim', 'oak', 'falcon', 'due.nvim', 'matchparen.nvim', 'github-nvim-theme', 'rainbow-delimiters.nvim', 'nightfox.nvim', 'hlargs.nvim', 'nvim-lspconfig'}, { event = "User s1" }, _G.packer_plugins)]]
