...
_G.packer_plugins = {
  ...
  ["nvim-cmp"] = {
    after = { "cmp-tabnine", "codeium.nvim", "cmp-buffer", "cmp-snippy", "cmp-cmdline-history", "cmp-spell", "cmp-calc", "cmp-cmdline", "cmp-nvim-lsp", "cmp-nvim-lsp-signature-help", "cmp-nvim-lua", "cmp-path", "cmp-rg", "nvim-snippy", "cmp-nvim-tags", "cmp-treesitter", "cmp-fish" },
...
vim.cmd [[au User s1 ++once lua require("packer.load")({'matchparen.nvim', 'oak', 'vim-im-select', 'nvim-ts-rainbow2', 'indent-blankline.nvim', 'vim-hexokinase', 'hlargs.nvim', 'due.nvim', 'nvim-lspconfig', 'lsp-colors.nvim', 'nightfox.nvim', 'nvim-ts-context-commentstring', 'falcon'}, { event = "User s1" }, _G.packer_plugins)]]
vim.cmd [[au CmdlineEnter * ++once lua require("packer.load")({'range-highlight.nvim', 'nvim-cmp', 'numb.nvim'}, { event = "CmdlineEnter *" }, _G.packer_plugins)]]
