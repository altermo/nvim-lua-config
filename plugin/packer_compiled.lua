...
_G.packer_plugins = {
  ...
  ["nvim-cmp"] = {
    after = { "nvim-snippy", "cmp-nvim-tags", "cmp-rg", "cmp-nvim-lsp", "cmp-calc", "cmp-spell", "cmp-snippy", "cmp-async-path", "cmp-buffer", "cmp-cmdline-history", "cmp-nvim-lsp-signature-help", "cmp-treesitter", "codeium.nvim", "cmp-cmdline" },
...
vim.cmd [[au FileType markdown ++once lua require("packer.load")({'vim-markdown-toc', 'markdown-preview.nvim', 'easyread.nvim', 'obsidian.nvim'}, { ft = "markdown" }, _G.packer_plugins)]]
...
vim.cmd [[au User s1 ++once lua require("packer.load")({'matchparen.nvim', 'nightfox.nvim', 'vim-hexokinase', 'nvim-lspconfig', 'indent-blankline.nvim', 'hlargs.nvim', 'due.nvim', 'github-nvim-theme', 'rainbow-delimiters.nvim'}, { event = "User s1" }, _G.packer_plugins)]]
