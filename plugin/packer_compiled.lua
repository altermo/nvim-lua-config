...
_G.packer_plugins = {
  ...
  ["nvim-cmp"] = {
    after = { "nvim-snippy", "cmp-rg", "cmp-nvim-lsp-signature-help", "cmp-cmdline", "cmp-nvim-tags", "cmp-calc", "cmp-fuzzy-buffer", "cmp-fish", "cmp-nvim-lua", "cmp-nvim-lsp", "cmp-buffer", "cmp-cmdline-history", "cmp-spell", "cmp-snippy", "cmp-tabnine", "cmp-path", "cmp-treesitter" },
...
vim.cmd [[au FileType puml ++once lua require("packer.load")({'vim-slumlord', 'plantuml-previewer.vim', 'open-browser.vim', 'plantuml-syntax'}, { ft = "puml" }, _G.packer_plugins)]]
...
vim.cmd [[au User s1 ++once lua require("packer.load")({'falcon', 'stabilize.nvim', 'oak', 'nvim-ts-rainbow', 'vim-im-select', 'vim-hexokinase', 'matchparen.nvim', 'nvim-treesitter-pairs', 'lsp-colors.nvim', 'indent-blankline.nvim', 'hlargs.nvim', 'nvim-lspconfig', 'nightfox.nvim', 'due.nvim', 'mkdir.nvim', 'nvim-ts-context-commentstring', 'abbreinder.nvim', 'FixCursorHold.nvim'}, { event = "User s1" }, _G.packer_plugins)]]
