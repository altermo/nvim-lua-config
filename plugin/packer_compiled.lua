...
_G.packer_plugins = {
  ...
  ["nvim-cmp"] = {
    after = { "cmp-spell", "cmp-cmdline-history", "cmp-fish", "cmp-nvim-lsp-signature-help", "cmp-buffer", "cmp-fuzzy-buffer", "cmp-treesitter", "cmp-calc", "cmp-nvim-lsp", "cmp-cmdline", "cmp-nvim-tags", "cmp-snippy", "cmp-tabnine", "cmp-rg", "cmp-nvim-lua", "cmp-path", "nvim-snippy" },
...
vim.cmd [[au User s1 ++once lua require("packer.load")({'nvim-treesitter-pairs', 'nightfox.nvim', 'mkdir.nvim', 'matchparen.nvim', 'lsp-colors.nvim', 'indent-blankline.nvim', 'vim-im-select', 'hlargs.nvim', 'falcon', 'due.nvim', 'oak', 'nvim-ts-rainbow', 'nvim-ts-context-commentstring', 'vim-hexokinase', 'abbreinder.nvim', 'nvim-lspconfig', 'FixCursorHold.nvim', 'stabilize.nvim'}, { event = "User s1" }, _G.packer_plugins)]]
