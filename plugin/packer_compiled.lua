...
_G.packer_plugins = {
  ...
  ["nvim-cmp"] = {
    after = { "cmp-spell", "cmp-tabnine", "cmp-rg", "nvim-snippy", "cmp-nvim-lsp-signature-help", "cmp-snippy", "cmp-buffer", "cmp-cmdline", "cmp-calc", "cmp-path", "cmp-cmdline-history", "cmp-treesitter", "cmp-nvim-lsp", "cmp-nvim-tags", "cmp-fuzzy-buffer", "cmp-nvim-lua", "cmp-fish" },
...
vim.cmd [[au FileType puml ++once lua require("packer.load")({'plantuml-syntax', 'open-browser.vim', 'vim-slumlord', 'plantuml-previewer.vim'}, { ft = "puml" }, _G.packer_plugins)]]
vim.cmd [[au FileType norg ++once lua require("packer.load")({'neorg'}, { ft = "norg" }, _G.packer_plugins)]]
vim.cmd [[au FileType html ++once lua require("packer.load")({'nvim-ts-autotag'}, { ft = "html" }, _G.packer_plugins)]]
vim.cmd [[au FileType markdown ++once lua require("packer.load")({'vim-markdown-toc', 'markdown-preview.nvim', 'mkdnflow.nvim'}, { ft = "markdown" }, _G.packer_plugins)]]
time([[Defining lazy-load filetype autocommands]], false)
  -- Event lazy-loads
time([[Defining lazy-load event autocommands]], true)
vim.cmd [[au User s1 ++once lua require("packer.load")({'matchparen.nvim', 'hlargs.nvim', 'oak', 'nvim-ts-rainbow', 'nvim-ts-context-commentstring', 'due.nvim', 'falcon', 'vim-hexokinase', 'nightfox.nvim', 'nvim-lspconfig', 'indent-blankline.nvim', 'lsp-colors.nvim', 'vim-im-select', 'nvim-treesitter-pairs'}, { event = "User s1" }, _G.packer_plugins)]]
...
vim.cmd [[au CmdlineEnter * ++once lua require("packer.load")({'range-highlight.nvim', 'nvim-cmp', 'numb.nvim', 'nvim-hlslens'}, { event = "CmdlineEnter *" }, _G.packer_plugins)]]
