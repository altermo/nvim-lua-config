...
_G.packer_plugins = {
  ...
  ["nvim-cmp"] = {
    after = { "nvim-snippy", "cmp-nvim-lsp-signature-help", "cmp-spell", "cmp-snippy", "codeium.nvim", "cmp-nvim-tags", "cmp-buffer", "cmp-rg", "cmp-path", "cmp-cmdline", "cmp-nvim-lua", "cmp-treesitter", "cmp-calc", "cmp-cmdline-history", "cmp-nvim-lsp", "cmp-tabnine" },
...
vim.cmd [[au User s1 ++once lua require("packer.load")({'falcon', 'matchparen.nvim', 'due.nvim', 'oak', 'vim-hexokinase', 'nvim-ts-context-commentstring', 'hlargs.nvim', 'indent-blankline.nvim', 'github-nvim-theme', 'vim-im-select', 'nvim-lspconfig', 'nightfox.nvim', 'rainbow-delimiters.nvim'}, { event = "User s1" }, _G.packer_plugins)]]
