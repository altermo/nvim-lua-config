...
_G.packer_plugins = {
  ...
  ["nvim-cmp"] = {
    after = { "cmp-tabnine", "nvim-snippy", "cmp-path", "cmp-fish", "cmp-nvim-lsp", "cmp-treesitter", "cmp-fuzzy-buffer", "cmp-cmdline-history", "cmp-buffer", "cmp-calc", "cmp-snippy", "cmp-cmdline", "cmp-nvim-tags", "cmp-nvim-lua", "cmp-nvim-lsp-signature-help", "cmp-spell", "cmp-rg" },
...
vim.cmd [[au User s1 ++once lua require("packer.load")({'oak', 'nvim-ts-rainbow', 'nvim-ts-context-commentstring', 'nvim-treesitter-pairs', 'vim-im-select', 'vim-hexokinase', 'nvim-lspconfig', 'hlargs.nvim', 'due.nvim', 'nightfox.nvim', 'mkdir.nvim', 'lsp-colors.nvim', 'abbreinder.nvim', 'falcon', 'FixCursorHold.nvim', 'stabilize.nvim', 'matchparen.nvim'}, { event = "User s1" }, _G.packer_plugins)]]
