...
_G.packer_plugins = {
  ...
  ["nvim-cmp"] = {
    after = { "cmp-nvim-lsp", "cmp-nvim-lsp-signature-help", "cmp-snippy", "cmp-cmdline", "cmp-path", "cmp-cmdline-history", "cmp-nvim-tags", "cmp-buffer", "nvim-snippy", "cmp-fish", "cmp-fuzzy-buffer", "cmp-spell", "cmp-calc", "cmp-treesitter", "cmp-nvim-lua", "cmp-tabnine", "cmp-rg" },
...
vim.cmd [[au User s1 ++once lua require("packer.load")({'stabilize.nvim', 'vim-im-select', 'vim-hexokinase', 'oak', 'nvim-ts-rainbow', 'nvim-ts-context-commentstring', 'mkdir.nvim', 'nvim-lspconfig', 'lsp-colors.nvim', 'indent-blankline.nvim', 'hlargs.nvim', 'due.nvim', 'nightfox.nvim', 'falcon', 'abbreinder.nvim', 'nvim-treesitter-pairs', 'FixCursorHold.nvim', 'matchparen.nvim'}, { event = "User s1" }, _G.packer_plugins)]]
