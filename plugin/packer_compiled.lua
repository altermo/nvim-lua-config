...
_G.packer_plugins = {
  ...
  ["nvim-cmp"] = {
    after = { "cmp-tabnine", "cmp-nvim-tags", "cmp-calc", "cmp-fish", "cmp-nvim-lsp-signature-help", "cmp-path", "cmp-snippy", "cmp-nvim-lsp", "codeium.nvim", "cmp-nvim-lua", "cmp-cmdline", "cmp-rg", "cmp-cmdline-history", "cmp-spell", "cmp-treesitter", "nvim-snippy", "cmp-buffer" },
...
vim.cmd [[au FileType markdown ++once lua require("packer.load")({'easyread.nvim', 'vim-markdown-toc', 'markdown-preview.nvim', 'mkdnflow.nvim'}, { ft = "markdown" }, _G.packer_plugins)]]
...
vim.cmd [[au User s1 ++once lua require("packer.load")({'oak', 'nvim-ts-rainbow2', 'nvim-ts-context-commentstring', 'nvim-treesitter-pairs', 'nvim-lspconfig', 'due.nvim', 'falcon', 'vim-im-select', 'nightfox.nvim', 'indent-blankline.nvim', 'vim-hexokinase', 'matchparen.nvim', 'lsp-colors.nvim', 'hlargs.nvim'}, { event = "User s1" }, _G.packer_plugins)]]
