...
_G.packer_plugins = {
  ...
  ["nvim-cmp"] = {
    after = { "cmp-rg", "cmp-tabnine", "cmp-spell", "nvim-snippy", "cmp-fish", "cmp-calc", "cmp-nvim-lsp-signature-help", "cmp-fuzzy-buffer", "cmp-cmdline-history", "cmp-cmdline", "cmp-buffer", "cmp-snippy", "cmp-treesitter", "cmp-nvim-lua", "cmp-nvim-tags", "cmp-path", "cmp-nvim-lsp" },
...
vim.cmd [[au FileType puml ++once lua require("packer.load")({'plantuml-syntax', 'plantuml-previewer.vim', 'vim-slumlord', 'open-browser.vim'}, { ft = "puml" }, _G.packer_plugins)]]
...
vim.cmd [[au User s1 ++once lua require("packer.load")({'falcon', 'nvim-treesitter-pairs', 'nvim-lspconfig', 'matchparen.nvim', 'lsp-colors.nvim', 'nightfox.nvim', 'oak', 'indent-blankline.nvim', 'nvim-ts-rainbow2', 'nvim-ts-context-commentstring', 'due.nvim', 'vim-im-select', 'hlargs.nvim', 'vim-hexokinase'}, { event = "User s1" }, _G.packer_plugins)]]
