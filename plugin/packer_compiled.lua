...
_G.packer_plugins = {
  ...
  ["nvim-cmp"] = {
    after = { "cmp-tabnine", "cmp-cmdline", "cmp-treesitter", "cmp-nvim-lsp", "cmp-cmdline-history", "cmp-nvim-tags", "cmp-snippy", "cmp-spell", "cmp-calc", "cmp-buffer", "cmp-nvim-lsp-signature-help", "cmp-async-path", "cmp-rg", "codeium.nvim", "nvim-snippy" },
...
vim.cmd [[au FileType markdown ++once lua require("packer.load")({'markdown-preview.nvim', 'mkdnflow.nvim', 'obsidian.nvim', 'easyread.nvim', 'vim-markdown-toc'}, { ft = "markdown" }, _G.packer_plugins)]]
...
vim.cmd [[au CmdlineEnter * ++once lua require("packer.load")({'nvim-cmp', 'range-highlight.nvim', 'numb.nvim'}, { event = "CmdlineEnter *" }, _G.packer_plugins)]]
vim.cmd [[au User s1 ++once lua require("packer.load")({'rainbow-delimiters.nvim', 'matchparen.nvim', 'vim-hexokinase', 'indent-blankline.nvim', 'nvim-lspconfig', 'hlargs.nvim', 'nightfox.nvim', 'github-nvim-theme', 'due.nvim'}, { event = "User s1" }, _G.packer_plugins)]]
