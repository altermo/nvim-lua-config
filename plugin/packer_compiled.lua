...
_G.packer_plugins = {
  ...
  ["competitest.nvim"] = {
    ...
    loaded = true,
    path = "/home/user/.local/share/nvim/site/pack/packer/start/competitest.nvim",
  ...
  ["indent-blankline.nvim"] = {
    config = { 'vim.g.indent_blankline_filetype_exclude={"dashboard"};require"indent_blankline".setup{\n  show_current_context = true\n}' },
    loaded = false,
    needs_bufread = false,
    only_cond = false,
  ...
  ["nvim-cmp"] = {
    after = { "nvim-snippy", "cmp-cmdline", "cmp-treesitter", "codeium.nvim", "cmp-snippy", "cmp-cmdline-history", "cmp-rg", "cmp-async-path", "cmp-calc", "cmp-nvim-tags", "cmp-nvim-lsp-signature-help", "cmp-nvim-lsp", "cmp-spell", "cmp-buffer", "cmp-tabnine" },
...
vim.cmd [[au FileType markdown ++once lua require("packer.load")({'vim-markdown-toc', 'easyread.nvim', 'mkdnflow.nvim', 'markdown-preview.nvim', 'obsidian.nvim'}, { ft = "markdown" }, _G.packer_plugins)]]
...
vim.cmd [[au FileType puml ++once lua require("packer.load")({'vim-slumlord', 'plantuml-syntax', 'plantuml-previewer.vim'}, { ft = "puml" }, _G.packer_plugins)]]
...
vim.cmd [[au User s1 ++once lua require("packer.load")({'hlargs.nvim', 'vim-hexokinase', 'github-nvim-theme', 'oak', 'falcon', 'due.nvim', 'nvim-lspconfig', 'nightfox.nvim', 'matchparen.nvim', 'rainbow-delimiters.nvim', 'indent-blankline.nvim'}, { event = "User s1" }, _G.packer_plugins)]]
