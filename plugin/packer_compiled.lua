...
vim.cmd [[noremap <silent> <w <cmd>lua require("packer.load")({'vim-pushover'}, { keys = "<lt>w", prefix = "" }, _G.packer_plugins)<cr>]]
...
vim.cmd [[noremap <silent> >p <cmd>lua require("packer.load")({'vim-pushover'}, { keys = ">p", prefix = "" }, _G.packer_plugins)<cr>]]
...
vim.cmd [[noremap <silent> >W <cmd>lua require("packer.load")({'vim-pushover'}, { keys = ">W", prefix = "" }, _G.packer_plugins)<cr>]]
...
vim.cmd [[noremap <silent> <p <cmd>lua require("packer.load")({'vim-pushover'}, { keys = "<lt>p", prefix = "" }, _G.packer_plugins)<cr>]]
