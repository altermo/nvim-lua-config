...
_G.packer_plugins = {
  ...
  ["nvim-cmp"] = {
    after = { "nvim-snippy", "cmp-rg", "cmp-spell", "cmp-fish", "cmp-nvim-lsp", "cmp-calc", "cmp-nvim-lsp-signature-help", "cmp-fuzzy-buffer", "cmp-nvim-tags", "cmp-cmdline-history", "cmp-cmdline", "cmp-nvim-lua", "cmp-buffer", "cmp-tabnine", "cmp-snippy", "cmp-path", "cmp-treesitter" },
...
vim.cmd [[au InsertEnter * ++once lua require("packer.load")({'nvim-cmp', 'abbreinder.nvim', 'nvim-treesitter-endwise'}, { event = "InsertEnter *" }, _G.packer_plugins)]]
...
vim.cmd [[au WinNew * ++once lua require("packer.load")({'colorful-winsep.nvim', 'Shade.nvim'}, { event = "WinNew *" }, _G.packer_plugins)]]
vim.cmd [[au User isfolded ++once lua require("packer.load")({'FastFold', 'pretty-fold.nvim'}, { event = "User isfolded" }, _G.packer_plugins)]]
vim.cmd [[au User s1 ++once lua require("packer.load")({'vim-im-select', 'vim-hexokinase', 'indent-blankline.nvim', 'hlargs.nvim', 'due.nvim', 'nvim-lspconfig', 'nightfox.nvim', 'matchparen.nvim', 'lsp-colors.nvim', 'nvim-treesitter-pairs', 'falcon', 'oak', 'nvim-ts-rainbow2', 'nvim-ts-context-commentstring'}, { event = "User s1" }, _G.packer_plugins)]]
