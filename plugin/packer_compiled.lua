...
_G.packer_plugins = {
  ...
  ["flit.nvim"] = {
    ...
    loaded = true,
    path = "/home/user/.local/share/nvim/site/pack/packer/start/flit.nvim",
  ...
  ["nvim-cmp"] = {
    after = { "cmp-buffer", "cmp-treesitter", "cmp-calc", "cmp-cmdline", "cmp-snippy", "cmp-nvim-lsp", "cmp-cmdline-history", "cmp-async-path", "cmp-spell", "cmp-rg", "codeium.nvim", "cmp-nvim-tags", "cmp-nvim-lsp-signature-help", "nvim-snippy" },
...
vim.cmd [[au FileType puml ++once lua require("packer.load")({'plantuml-syntax', 'vim-slumlord', 'plantuml-previewer.vim'}, { ft = "puml" }, _G.packer_plugins)]]
vim.cmd [[au FileType terminal ++once lua require("packer.load")({'nvim-terminal.lua'}, { ft = "terminal" }, _G.packer_plugins)]]
vim.cmd [[au FileType html ++once lua require("packer.load")({'tagalong.vim', 'nvim-ts-autotag'}, { ft = "html" }, _G.packer_plugins)]]
...
vim.cmd [[au FileType markdown ++once lua require("packer.load")({'obsidian.nvim', 'markdown-preview.nvim', 'vim-markdown-toc', 'easyread.nvim'}, { ft = "markdown" }, _G.packer_plugins)]]
...
vim.cmd [[au User s1 ++once lua require("packer.load")({'hlargs.nvim', 'github-nvim-theme', 'due.nvim', 'matchparen.nvim', 'vim-hexokinase', 'nightfox.nvim', 'rainbow-delimiters.nvim', 'nvim-lspconfig', 'indent-blankline.nvim'}, { event = "User s1" }, _G.packer_plugins)]]
