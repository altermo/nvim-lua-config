...
_G.packer_plugins = {
  ...
  ["nvim-cmp"] = {
    after = { "cmp-nvim-tags", "cmp-tabnine", "cmp-rg", "cmp-spell", "cmp-path", "cmp-nvim-lsp", "cmp-calc", "cmp-snippy", "cmp-nvim-lua", "codeium.nvim", "cmp-fish", "cmp-treesitter", "cmp-buffer", "cmp-cmdline", "cmp-cmdline-history", "cmp-nvim-lsp-signature-help", "nvim-snippy" },
...
vim.cmd [[au FileType markdown ++once lua require("packer.load")({'easyread.nvim', 'mkdnflow.nvim', 'markdown-preview.nvim', 'vim-markdown-toc'}, { ft = "markdown" }, _G.packer_plugins)]]
...
vim.cmd [[au CmdlineEnter * ++once lua require("packer.load")({'numb.nvim', 'nvim-hlslens', 'range-highlight.nvim', 'nvim-cmp'}, { event = "CmdlineEnter *" }, _G.packer_plugins)]]
vim.cmd [[au User s1 ++once lua require("packer.load")({'oak', 'due.nvim', 'vim-hexokinase', 'nvim-ts-context-commentstring', 'nvim-lspconfig', 'hlargs.nvim', 'indent-blankline.nvim', 'falcon', 'matchparen.nvim', 'lsp-colors.nvim', 'nvim-ts-rainbow2', 'nightfox.nvim', 'vim-im-select'}, { event = "User s1" }, _G.packer_plugins)]]
...
vim.cmd [[au InsertEnter * ++once lua require("packer.load")({'nvim-treesitter-endwise', 'abbreinder.nvim', 'nvim-cmp'}, { event = "InsertEnter *" }, _G.packer_plugins)]]
