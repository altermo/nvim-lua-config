...
_G.packer_plugins = {
  ...
  ["nvim-cmp"] = {
    after = { "nvim-snippy", "cmp-fuzzy-buffer", "cmp-nvim-lsp", "cmp-cmdline", "cmp-path", "cmp-fish", "cmp-nvim-lua", "cmp-calc", "cmp-nvim-lsp-signature-help", "cmp-cmdline-history", "cmp-snippy", "cmp-buffer", "cmp-treesitter", "cmp-nvim-tags", "cmp-spell", "cmp-rg", "cmp-tabnine" },
...
vim.cmd [[au User s1 ++once lua require("packer.load")({'due.nvim', 'nvim-lspconfig', 'nightfox.nvim', 'mkdir.nvim', 'matchparen.nvim', 'stabilize.nvim', 'abbreinder.nvim', 'FixCursorHold.nvim', 'oak', 'nvim-ts-rainbow', 'nvim-ts-context-commentstring', 'falcon', 'hlargs.nvim', 'nvim-treesitter-pairs', 'indent-blankline.nvim', 'vim-im-select', 'vim-hexokinase', 'lsp-colors.nvim'}, { event = "User s1" }, _G.packer_plugins)]]
