...
_G.packer_plugins = {
  ...
  ["nvim-cmp"] = {
    after = { "cmp-snippy", "cmp-path", "cmp-treesitter", "cmp-nvim-lsp-signature-help", "cmp-rg", "cmp-nvim-lsp", "cmp-spell", "cmp-nvim-tags", "cmp-cmdline-history", "cmp-cmdline", "codeium.nvim", "cmp-buffer", "cmp-tabnine", "nvim-snippy", "cmp-calc" },
...
vim.cmd [[au FileType markdown ++once lua require("packer.load")({'easyread.nvim', 'vim-markdown-toc', 'mkdnflow.nvim', 'markdown-preview.nvim'}, { ft = "markdown" }, _G.packer_plugins)]]
...
vim.cmd [[au User s1 ++once lua require("packer.load")({'oak', 'nvim-treesitter-refactor', 'nvim-lspconfig', 'indent-blankline.nvim', 'matchparen.nvim', 'hlargs.nvim', 'falcon', 'due.nvim', 'vim-hexokinase', 'nightfox.nvim', 'rainbow-delimiters.nvim', 'github-nvim-theme'}, { event = "User s1" }, _G.packer_plugins)]]
