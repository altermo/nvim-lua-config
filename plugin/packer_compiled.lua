...
_G.packer_plugins = {
  ...
  ["nvim-cmp"] = {
    after = { "cmp-cmdline-history", "cmp-nvim-lua", "cmp-nvim-tags", "cmp-cmdline", "cmp-path", "cmp-spell", "cmp-nvim-lsp", "cmp-rg", "codeium.nvim", "cmp-treesitter", "cmp-fish", "cmp-tabnine", "nvim-snippy", "cmp-buffer", "cmp-snippy", "cmp-calc", "cmp-nvim-lsp-signature-help" },
...
vim.cmd [[au FileType markdown ++once lua require("packer.load")({'markdown-preview.nvim', 'easyread.nvim', 'vim-markdown-toc', 'mkdnflow.nvim'}, { ft = "markdown" }, _G.packer_plugins)]]
...
vim.cmd [[au User s1 ++once lua require("packer.load")({'matchparen.nvim', 'nightfox.nvim', 'oak', 'nvim-ts-rainbow2', 'falcon', 'nvim-lspconfig', 'due.nvim', 'vim-im-select', 'vim-hexokinase', 'lsp-colors.nvim', 'hlargs.nvim', 'nvim-ts-context-commentstring', 'indent-blankline.nvim'}, { event = "User s1" }, _G.packer_plugins)]]
vim.cmd [[au InsertEnter * ++once lua require("packer.load")({'abbreinder.nvim', 'nvim-cmp', 'nvim-treesitter-endwise'}, { event = "InsertEnter *" }, _G.packer_plugins)]]
