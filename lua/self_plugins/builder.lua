local BUILDERS = {python = true, fish = true, lua = true, fennel = true, cs = {"csharp"}, rust = {"cargo run"}, cpp = "AsyncRun zig c++ -O2 % -o __tmp;./__tmp;rm __tmp", c = "AsyncRun zig cc -O2 % -o __tmp -llua;./__tmp;rm __tmp", vim = "so %", zig = {"zig run"}}
local function eval()
