...
vim.keymap.set('x','<C-j>','<cmd>STSSelectNextSiblingNode\r',{noremap=true,silent=true})
vim.keymap.set('x','<C-k>','<cmd>STSSelectPrevSiblingNode\r',{noremap=true,silent=true})
vim.keymap.set('x','<C-h>','<cmd>STSSelectParentNode\r',{noremap=true,silent=true})
vim.keymap.set('x','<C-l>','<cmd>STSSelectChildNode\r',{noremap=true,silent=true})
vim.keymap.set('x','<C-S-j>','<cmd>STSSwapNextVisual\r',{noremap=true,silent=true})
vim.keymap.set('x','<C-S-k>','<cmd>STSSwapPrevVisual\r',{noremap=true,silent=true})
vim.keymap.set('x','<C-S-h>',':m 0\rgv',{noremap=true,silent=true})
vim.keymap.set('x','<C-S-l>',':m $\rgv',{noremap=true,silent=true})
